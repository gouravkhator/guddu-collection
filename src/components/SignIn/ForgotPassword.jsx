...
export default function ForgotPassword() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setMessage(
        "Check your mail, and follow the link sent for resetting the password. In case you could not find any mail, please check the spam folder."
      );
    } catch (err) {
      if (err.code === "auth/user-not-found") {
        setError("Email not found. Please signup to continue..");
      } else {
        setError(
          "Unable to send a reset password request. Please try again later.."
        );
      }
    }
    setLoading(false);
